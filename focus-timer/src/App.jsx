...
function App() {
  ...
  const DEFAULT_FOCUS_TIME = 10 * 60; // 10 minutes baseline
  ...
  return (
    <div className="mobile-shell">
      {/* Updated Navbar Title Header (All Caps) */}
      ...
      <div className="scrollable-content-window">
        ...
        <div className="signature-branding-tag">@florence-pomodoro-timer</div>
      </div>
    </div>
  );
}
